...
<style>
.stApp {
background-image: url("https://images.wallpaperscraft.com/image/single/smiles_emoticons_balls_141899_1366x768.jpg");
...
try:
    ...
    for l,a,n,i in zip(new_df["link"],new_df['artist'],new_df['name'],range(30)):
        ...
        st.markdown("""<h4 style='text-align:center;color:black;'><a style='color:black;font-size:25px;font-weight:bold;' href={}>{} - {}</a></h4>""".format(l,i+1,n),unsafe_allow_html=True)

        # Artist name
        st.markdown("<h5 style='text-align:center;color:black;'><i>{}</i></h5>".format(a), unsafe_allow_html=True)
